...
extern float Encoder_A,Encoder_B,Encoder_C,Encoder_D;                    //编码器的脉冲计数
...
extern float Real_Distance;                                           //超声波测距
extern u8 delay_50,delay_flag;

extern u8 Urxbuf[17],Utxbuf[21],Usart_ON_Flag;
extern float Pitch,Roll,Yaw,Move_X,Move_Y,Move_Z; 
extern float Position_A,Position_B,Position_C,Position_D;
...
extern int Gryo_Z;
extern int set_pwm_flag;
extern unsigned char Rrxbuf[3];
...
extern short X, Y;
extern float angle;
extern double x, y, xmax, xmin, ymax, ymin,offset_x, offset_y,x_gain,y_gain;
extern float light_offset, angle_sum;
extern int power_on,angle_count;
#define EN PAin(12)
#define DEBUG 0
